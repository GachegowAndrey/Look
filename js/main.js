    ...
    { 
      ...
      data: { // общие данные графика в виде объекта
        labels: ['1-7 Jule','8-14 Jule', '15-21 Jule', '22-28 Jule',
         ...
         '23-29Sen','30Sen-6 Oct','7-13 Oct','14-20 Oct','21-27 Oct',
         '28 Oct-3 Nov','4-10 Nov','11-17 Nov','18-24 Nov','25Nov-1Dec','2-8 Dec'], // метки по оси X
        datasets: [ // набор данных, который будет отрисовываться в виде массива с объектами
          { 
              ...
              data: [735, 806, 675, 969, 630,407,1107,827,
              547,457,639,500,438,743,584,376,606,610,1066,1006,1043,1167,1338],
    ...
    { 
      ...
      data: { // общие данные графика в виде объекта
        labels: ['1-7 Jule','8-14 Jule', '15-21 Jule',
         ...
         '7-13 Oct','14-20 Oct','21-27 Oct',
         '28 Oct-3 Nov','4-10 Nov','11-17 Nov','18-24 Nov','25Nov-1Dec','2-8 Dec'], // метки по оси X
        datasets: [ // набор данных, который будет отрисовываться в виде массива с объектами
          { 
              label: 'Time(minutes)', // название для определенного графика в виде строки
              data: [377, 438, 230, 246, 213,213,
              356,293,190,188,201,152,128,143,153,106,184,190,203,207,229,222,279],
              // данные в виде массива с числами, количество должно совпадать с количеством меток по оси X
               backgroundColor: [
      'rgba(235, 85, 145, 0.5)',
      'rgba(210, 170, 30, 0.5)',
    ...
    { 
      ...
      data: { // общие данные графика в виде объекта
        labels: ['1-7 Jule','8-14 Jule', '15-21 Jule',
         ...
         '12-18 Aug','19-25 Aug','26Aug-1Sen','2-8Sen',
         '9-15Sen','16-22Sen','23-29Sen','30Sen-6 Oct',
         '7-13 Oct','14-20 Oct','21-27 Oct','28 Oct-3 Nov',
         '4-10 Nov','11-17 Nov','18-24 Nov','25Nov-1Dec','2-8 Dec'], // метки по оси X
        datasets: [ // набор данных, который будет отрисовываться в виде массива с объектами
          { 
              label: 'Words', // название для определенного графика в виде строки
              data: [363, 373, 112, 3, 26,14,9,19,23,4,1,1,129,136,1,4,5,12,40,3,0,0,1],
              // данные в виде массива с числами, количество должно совпадать с количеством меток по оси X
               backgroundColor: [
      'rgba(255, 99, 132, 0.2)',
      'rgba(255, 159, 64, 0.2)',
      ...
      data: { // общие данные графика в виде объекта
        ...
        datasets: [ // набор данных, который будет отрисовываться в виде массива с объектами
          { 
              ...
              data: [632, 734, 582, 607, 544,417,
              848,645,380,329,405,316,278,443,354,266,443,455,848,784,797,898,1037],
              // данные в виде массива с числами, количество должно совпадать с количеством меток по оси X
      ...
      data: { // общие данные графика в виде объекта
        ...
        datasets: [ // набор данных, который будет отрисовываться в виде массива с объектами
          { 
              ...
              data: [50, 58, 46, 48, 43,33,67,51,30,26,32,25,28,35,28,21,35,36,67,62,63,71,82],
              // данные в виде массива с числами, количество должно совпадать с количеством меток по оси X
