    ...
    { 
      ...
      data: { // общие данные графика в виде объекта
        labels: ['1-7 Jule','8-14 Jule', '15-21 Jule', '22-28 Jule',
         ...
         '19-25 Aug','26Aug-1Sen','2-8Sen','9-15Sen'], // метки по оси X
        datasets: [ // набор данных, который будет отрисовываться в виде массива с объектами
          { 
              ...
              data: [735, 806, 675, 969, 630,407,1107,827,547,457,639],
    ...
    { 
      ...
      data: { // общие данные графика в виде объекта
        labels: ['1-7 Jule','8-14 Jule', '15-21 Jule',
         ...
         '12-18 Aug','19-25 Aug','26Aug-1Sen','2-8Sen','9-15Sen'], // метки по оси X
        datasets: [ // набор данных, который будет отрисовываться в виде массива с объектами
          { 
              label: 'Time(minutes)', // название для определенного графика в виде строки
              data: [377, 438, 230, 246, 213,213,356,293,190,188,201],
              // данные в виде массива с числами, количество должно совпадать с количеством меток по оси X
               backgroundColor: [
      'rgba(255, 99, 132, 0.5)',
      'rgba(255, 159, 64, 0.5)',
      ...
      data: { // общие данные графика в виде объекта
        ...
        datasets: [ // набор данных, который будет отрисовываться в виде массива с объектами
          { 
              ...
              data: [363, 373, 112, 3, 26,14,9,19,23,4,1],
              // данные в виде массива с числами, количество должно совпадать с количеством меток по оси X
               backgroundColor: [
      'rgba(255, 99, 132, 0.2)',
      'rgba(255, 159, 64, 0.2)',
      ...
      data: { // общие данные графика в виде объекта
        ...
        datasets: [ // набор данных, который будет отрисовываться в виде массива с объектами
          { 
              ...
              data: [632, 734, 582, 607, 544,417,848,645,380,329,405],
              // данные в виде массива с числами, количество должно совпадать с количеством меток по оси X
      ...
      data: { // общие данные графика в виде объекта
        ...
        datasets: [ // набор данных, который будет отрисовываться в виде массива с объектами
          { 
              ...
              data: [50, 58, 46, 48, 43,33,67,51,30,26,32],
              // данные в виде массива с числами, количество должно совпадать с количеством меток по оси X
